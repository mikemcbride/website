    ...
    <Layout pageTitle={title} description={description}>
        ...
        <article className="prose lg:prose-xl mb-16 text-black dark:text-gray-300">
            ...
            <ul>
                ...
                <li>5-6 green onions, finely chopped</li>
            ...
            <ul>
                ...
                <li>In a cast iron pot, make the roux. Cook the flour and oil together over medium heat until it's between the color of peanut butter and a Hershey bar (you can go darker if you wish). Stir constantly so you do not burn it!</li>
                ...
                <li>Add the chicken, sausage, and remaining vegetables and seasonings (garlic, green onion, parsley, bay leaves, Tony's, red and black pepper). Stir to blend.</li>
