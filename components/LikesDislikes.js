    ...
    return (
        <div className="flex flex-col md:flex-row ml-4 md:ml-0 md:justify-center">
          <section className="mb-12 md:mb-20 md:mr-10">
            <h2
              className="font-sans rounded font-bold text-3xl mb-4 bg-hot-pink text-white py-1 px-3 transform -rotate-1 inline-block"
            >Things I Like</h2>
            <ul>
          ...
          <section className="mb-20 md:ml-10">
            <h2
            className="font-sans rounded font-bold text-3xl mb-4 bg-blue text-white py-1 px-3 transform rotate-1 inline-block"
            >
            Things I Dislike
            </h2>
            <ul>
