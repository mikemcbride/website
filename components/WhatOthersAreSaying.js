...
export default function WhatOthersAreSaying() {
    return (
        <div className="mb-40 max-w-full px-2">
            <h2 className="inline-block bg-gradient-to-r from-aqua to-blue transform -skew-x-6 text-white font-black font-sans text-3xl py-2 px-3 mb-8">What others are saying...</h2>
            ...
            <div className="relative text-gray-700 dark:text-gray-400 text-lg md:text-xl md:ml-16 md:w-1/2 mb-16">
                <BigQuote />
