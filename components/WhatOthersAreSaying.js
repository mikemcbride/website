    ...
    return (
        <div className="mb-40 max-w-full">
            ...
            <section className="px-2 flex flex-col items-center">
                ...
                <div className="font-slab font-medium relative transform rotate-1 text-gray-700 dark:text-gray-300 text-lg md:text-2xl md:ml-24 self-start md:w-1/2 mb-16">
                    <BigQuote />
