...
function BlogListItem({ post }) {
    ...
    return (
        <article className="py-8">
            ...
            <p className="text-black dark:text-gray-200 mb-6 leading-loose text-base">{post.frontmatter.excerpt}</p>
            <Link href={href} className="group inline-flex items-center text-sm text-blue dark:text-blue-400 no-underline uppercase tracking-wide">
