...
export default function SiteFooter() {
    ...
    return (
        <footer className="text-center relative">
            <div className="flex items-center justify-center text-hot-pink dark:text-pink-500">
