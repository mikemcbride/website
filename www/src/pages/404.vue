<template lang="html">
  <div class="bg-white text-black dark:bg-black dark:text-white h-screen flex items-center justify-center font-sans">
    <div class="flex flex-col md:flex-row items-center max-w-3xl px-4">
      <div
      ...
      <p class="mb-0 text-center md:text-left">Sorry... <code>{{ $route.path }}</code> doesn't exist. <g-link to="/">Take me home</g-link>.</p>
    </div>
  </div>
</template>
